...
<!--[if lt IE 9]>
 ...
 <div class="headermain">
    <!--#include file ="cookie.inc.asp" -->       
	<!--#include file ="mailchimp.inc.asp" -->        
   <div class="contentwrapper">
   <div class="row clearfix">
     <a href="#" class="showprompt"><span class="icon-newsletter"></span>sign up to our newsletter</a>
     <div class="col-4">
   ...
   <nav>
	...
	<ul id="menu">
            ...
            <li><a href="index.asp" class="dropdown icon-dropdown">About</a>
              <div class="submenu">
                <ul class="ddleft">
              ...
              <div class="submenu products">
                <ul class="ddleft">
                 ...
                 <ul class="ddright">
                      ...
                      <li><a href="<%=SITE_ROOT_PATH%>listing.asp?Make=Value">Value Range</a></li>
                      <li><a href="<%=SITE_ROOT_PATH%>listing.asp?Make=Student">Student Rentals</a></li>
                 </ul>
               </div>
             </li>
    ...
    <div class="wrapper">
  	<a href="#" id="togglemenu" class="icon-menu">Menu</a>
            ...
            <a href="#" class="showprompt"><span class="icon-newsletter"></span></a>
            <a href="index.asp"><img src="<%=SITE_ROOT_PATH%>images/forbes-logo-mobile.png" class="forbeslogo" alt="Forbes Rentals" /></a>
      		<p class="tel large"><span class="icon-callus"></span>0800 00 63 00</p>
     	  </div>   