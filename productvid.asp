   ...
   <div class="contentwrapper">
     ...
     <div class="module-product-video clearfix">
       <div class="col-8 col-expanded">
          <hgroup>
           ...
           <div class="row clearfix">
                <div class="col-11 col-video">
                     <div class="video-wrapper">
                       <div class="controls-right"></div>
                       <div class="controls-right"></div>
                            <video src="images/video/File_9294_H264-Web.mp4" controls poster="images/video/preview/File_9296_JPEG-Web.jpg" class="product-video" id="product-video">
                            </video>
                            <img src="bosch-1.png" alt="Bosch 1" class="main-image" />
                     </div> <!-- video-wrapper //-->
                </div> <!-- col-9 //-->
                <div class="col-1 col-product-thumbnails">
                   <!-- <ul class="thumbs"> //-->
                        <img src="video.png" alt="" class="thumb-video" />  
                        <img src="bosch-1.png" alt="" class="thumb-" /> 
                        <img src="bosch-2.png" alt="" class="thumb-" />
                        <img src="bosch-3.png" alt="" class="thumb-" />
                        <img src="bosch-4.png" alt="" class="thumb-" />
                        <img src="bosch-5.png" alt="" class="thumb-" /> 
                        <img src="bosch-6.png" alt="" class="thumb-" />
                        <img src="bosch-7.png" alt="" class="thumb-" />
                        <img src="bosch-8.png" alt="" class="thumb-" />
                        <img src="bosch-9.png" alt="" class="thumb-" />
                  <!--  </ul> //-->
                </div> <!-- col-2 //-->
           </div>  <!-- row //-->
      ...
      <div class="product-features">
        ...
        <div class="col-9">
           ...
           <ul class="product-features-list-full">
    ...
    <div class="row clearfix">
        <div class="module clearfix">
            <div class="col-12">
              <h3 class=""><a href="#" class="tab-like">You may also like</a> / <a href="#" class="tab-viewed">recently viewed</a></h3>
            </div>
            <div class="module-liked">
               <div class="col-3 centered col-pair">
                   <div class="related-product">
                     <a href="#"><img src="images/img-related-wm.png" alt="" /></a>
                     <p><a href="#">Bosch</a></p>
                     <p><a href="#">Washing Machine</a></p>
                    <div class="module-price-type-related">
                      <p class="rental-type-related">Weekly Rental</p>
                      <p class="price-point-related">&pound;4.50</p>
                    </div>
                   </div> 
               </div>
                <div class="col-3 centered col-pair">
            ...
            <div class="module-viewed">
               <div class="col-3 centered col-pair">
                   <div class="related-product">
                     <a href="#"><img src="images/img-related.png" alt="" /></a>
                     <p><a href="#">Bosch</a></p>
                     <p><a href="#">Condensed Dryer</a></p>
                    <div class="module-price-type-related">
                      <p class="rental-type-related">Weekly Rental</p>
                      <p class="price-point-related">&pound;3.00</p>
                    </div>
                   </div> 
               </div>
                <div class="col-3 centered col-pair">
