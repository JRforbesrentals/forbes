...
Dim rsList__varList
rsList__varList = "Student"
If (Request.querystring("Make") <> "") Then 
  rsList__varList = Request.querystring("Make")
  Session("Cat")=Request.querystring("Make")
  Else 
...
rsList_cmd.CommandText = "SELECT P.*, S.Supplier, S.buttonup, C.Category FROM NewProducts P, Suppliers S, Categories C WHERE P.Supplier = S.SupplierID AND P.Category = C.CategoryID AND [current]=-1 AND P.Make Like ?" 
