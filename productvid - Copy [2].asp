    ...
    <div class="row clearfix">
       <div class="module-product-video clearfix">
         <div class="col-7 col-expanded"> 
          <hgroup>
           ...
           <div class="video-wrapper">
               <video src="images/video/File_9294_H264-Web.mp4" controls poster="images/video/preview/File_9296_JPEG-Web.jpg" class="product-video">
               </video>
         ...
         <div class="col-1 centered">
             <ul class="thumbs">
               <li><img src="video.png" alt="" class="videothumb" /></li>  
               <li><img src="bosch-1.png" alt="" class="thumbs" /></li>  
               <li><img src="bosch-2.png" alt="" class="thumbs" /></li>
               <li><img src="bosch-3.png" alt="" class="thumbs" /></li>
               <li><img src="bosch-4.png" alt="" class="thumbs" /></li>
             </ul>
         </div>
