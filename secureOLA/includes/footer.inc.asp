<footer>
     <div class="contentwrapper">
       ...
       <div class="row cleafix">
        <ul class="support col-4">
          <li><a href="Call.asp" class="button-callback">Book a Callback</a></li>
        ...
        <ul class="support col-4">
          <li><a href="<%=SITE_ROOT_PATH%>apply.asp">Apply Online</a></li>
          <li><a href="contact.asp#postal">Postal Address</a></li>
         </ul><div class="clearfix"></div>
       </div>
   		<div class="row clearfix socialmodule">   
       <div class="col-4">
            <img src="<%=SITE_ROOT_PATH%>images/forbes-logo-grey.png" alt="Forbes Rentals logo" class="forbes-logo" />
       </div>
       <div class="col-4">
      ...
      <div class="row clearfix">
   	 ...
   	 <div class="row clearfix">
       <div class="col-12">    
        <p class="small">Copyright &copy; 2016 F Donald Forbes &amp; Co Ltd T/A Forbes Rentals, 7 Wells Place, Redhill, Surrey. RH 1 3DR. Registered England 687172</p>
 ...
 <%Response.Write(Session("source"))%>
</div> <!-- wrapper //-->  
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
    <!--[if IE 9]>
     <script src="<%=SITE_ROOT_PATH%>scripts/ie9.js"></script>
    <![endif]-->
    <script src="<%=SITE_ROOT_PATH%>scripts/forbes.js"></script>
 </body>
</html>